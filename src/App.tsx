  ...
  return (
    <ThemeProvider defaultTheme="light" storageKey="vite-ui-theme">
      ...
      >
        ...
        <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-40 flex flex-wrap justify-center gap-3 bg-rose-50/95 dark:bg-pink-950/95 rounded-full px-4 py-3 shadow-xl border border-rose-100 dark:border-pink-900 backdrop-blur-md w-[calc(100vw-2rem)] max-w-[46rem]">
          {[
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 rounded-full bg-rose-100/90 dark:bg-pink-950/80 px-3 py-2 text-neutral-700 dark:text-neutral-200 hover:bg-rose-200 dark:hover:bg-pink-900/70 hover:text-pink-600 dark:hover:text-pink-300 transition-all duration-200 shadow-sm"
              title={item.label}
