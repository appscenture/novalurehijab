  ...
  return (
    <ThemeProvider defaultTheme="light" storageKey="vite-ui-theme">
      ...
      >
        ...
        <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-40 flex flex-wrap justify-center gap-3 bg-rose-50/95 dark:bg-pink-950/95 rounded-full px-4 py-3 shadow-xl border border-rose-100 dark:border-pink-900 backdrop-blur-md">
          {[
